...
import { VaultCenterpiece } from './VaultCenterpiece';
import { QuestionConsole } from './QuestionConsole';
import { PowerBoostConsole } from './PowerBoostConsole';
import { AnswerConsole } from './AnswerConsole';
import { GameFeedback } from './GameFeedback';
import { CountdownOverlay } from './CountdownOverlay';
import { ArcadeStartScreen } from './ArcadeStartScreen';
...
export const MathVaultGame: React.FC = () => {
  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden flex flex-col justify-between p-2 sm:p-4 select-none bg-[#020409]">
      {/* 3D Depth Cavern Background */}
      <CaveScene />
      ...
      {(phase === 'playing' || phase === 'round_reveal') && (
        <div className="relative w-full h-full flex flex-col justify-between max-w-[1920px] mx-auto z-20">
          ...
          {/* CENTER AREA: GIANT HERO GOLDEN VAULT DOOR */}
          <div className="relative flex-1 flex items-center justify-center -my-3 sm:-my-6">
            <VaultCenterpiece
          ...
          {/* BOTTOM AREA: PHYSICAL DUAL TOUCH CONTROL PANELS */}
