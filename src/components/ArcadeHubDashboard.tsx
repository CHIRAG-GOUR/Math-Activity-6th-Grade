...
const ARCADE_GAMES: ArcadeGameData[] = [
  ...
  },
  {
    ...
    number: '02',
    title: 'NUMBER FORGE',
    subtitle: 'Place Value & Rounding Workshop',
    grade: 'Grade 6',
    ...
    theme: {
      cabinetColor: 'bg-gradient-to-b from-[#78350f] via-[#451a03] to-[#291004]',
      marqueeBg: 'bg-gradient-to-r from-amber-500 via-orange-400 to-amber-600',
      marqueeText: 'text-slate-950',
      bezelBorder: 'border-[#d4944d]',
      joystickColor: 'bg-amber-500',
      buttonColors: ['bg-amber-400', 'bg-orange-500', 'bg-emerald-500', 'bg-red-500'],
  ...
  },
  {
    ...
    description: 'Operate a 3D railway network! Use place value and rounding to route trains, switch tracks, and restore the Great Number Railway.',
