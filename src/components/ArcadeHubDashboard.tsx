...
const ACTIVITIES_LIST: ActivityItem[] = [
  ...
  {
    id: 'fraction-factory-blitz',
    number: '02',
    title: 'FRACTION FACTORY BLITZ',
    subtitle: 'Pizza Gears & Ratio Assembly Line',
    grade: 'Grade 6',
    category: 'Speed Duel',
    status: 'in-development',
    image: '/images/math-vault-card.jpg',
    route: '/fraction-factory',
    description: 'Assemble pizza slices, synchronize mechanical fraction cogs, and balance equivalent ratios under time pressure.',
    tags: ['Equivalent Fractions', 'Improper & Mixed', 'Ratio Matching'],
    features: [
      'Interactive visual fraction cutting blade',
      'Real-time conveyor belt mechanics',
      'Team duel scoring multiplier',
    ],
    players: '2-4 Teams',
  },
  {
    id: 'algebra-cypher-dungeon',
    number: '03',
    title: 'ALGEBRA CYPHER DUNGEON',
    subtitle: 'Variable Equations & Rune Decoding',
    grade: 'Grade 6-7',
    category: 'Puzzle & Logic',
    status: 'planned',
    image: '/images/math-vault-card.jpg',
    route: '/algebra-dungeon',
    description: 'Decode ancient stone tablets by solving linear equations and finding missing variables before the dungeon doors close.',
    tags: ['One-Step Equations', 'Two-Step Algebra', 'Substitution'],
    features: [
      'Ancient rune decoder board',
      'Step-by-step balance scale model',
      'Classroom cooperative boss battle',
    ],
    players: 'Whole Class / 2 Teams',
  },
  {
    id: 'geometry-laser-run',
    number: '04',
    title: 'GEOMETRY LASER RUN',
    subtitle: 'Angle Reflector & Polygon Grid',
    grade: 'Grade 6',
    category: 'Arcade Arena',
    status: 'planned',
    image: '/images/math-vault-card.jpg',
    route: '/geometry-laser',
    description: 'Calculate complementary, supplementary, and polygon angle totals to deflect high-speed laser beams to target sensors.',
    tags: ['Angle Calculation', 'Triangle Sums', 'Polygon Sides'],
    features: [
      'Reflective mirror angle placement',
      'Dynamic protractor measurement',
      'Rapid speed reflex rounds',
    ],
    players: '2 Teams',
  },
];
...
export const ArcadeHubDashboard: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'Speed Duel', label: 'SPEED DUEL' },
