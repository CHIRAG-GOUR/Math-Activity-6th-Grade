...
export const RAW_ARCADE_CABINET_DATA: Omit<ArcadeCabinetConfig, 'position' | 'rotation'>[] = [
  ...
  },
  {
    ...
    number: '12',
    title: 'PARK PLANNER',
    subtitle: 'The Four-Quadrant City Park • Cartesian Coordinate Duel',
    topic: 'Position & Transformation',
    grade: 'Grade 6',
    category: '3D City Park Simulation',
    status: 'active',
    image: '/images/park-planner-card.jpg',
    route: '/park-planner',
    theme: {
      cabinetColor: '#047857',
      ...
      tMoldingEmissive: '#d97706',
      marqueeBg: '#065f46',
      marqueeTextColor: '#fef3c7',
      marqueeGlow: '#34d399',
      screenBezelColor: '#064e3b',
      screenGlowColor: '#10b981',
      deckColor: '#0f766e',
      joystickBallColor: '#f59e0b',
      joystickBallEmissive: '#d97706',
      buttonColors: ['#10b981', '#3b82f6', '#ef4444', '#f59e0b'],
      coinDoorColor: '#064e3b',
      sideArtAccent: '#a7f3d0',
      floorGlowColor: '#10b981',
      topicBadgeBg: '#d1fae5',
