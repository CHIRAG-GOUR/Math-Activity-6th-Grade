...
export const RAW_ARCADE_CABINET_DATA: Omit<ArcadeCabinetConfig, 'position' | 'rotation'>[] = [
  ...
  },
  {
    id: 'pattern-racers',
    number: '06',
    title: 'PATTERN RACERS',
    subtitle: 'Sequence & Function Grand Prix',
    topic: 'Sequences & Functions',
    grade: 'Grade 6',
    category: 'Grand Prix & Racing',
    status: 'active',
    image: '/images/pattern-racers-card.jpg',
    ...
    theme: {
      ...
      joystickBallColor: '#fbbf24',
      joystickBallEmissive: '#f59e0b',
      buttonColors: ['#fbbf24', '#f97316', '#38bdf8', '#22c55e'],
  ...
  },
  {
    id: 'decimal-delivery',
    number: '07',
    title: 'DECIMAL DELIVERY',
    subtitle: 'The Decimal Delivery Network',
    topic: 'Decimals',
    grade: 'Grade 6',
  ...
  },
  {
    ...
    subtitle: 'The Great Angle Energy Challenge',
    ...
    theme: {
      ...
      marqueeTextColor: '#ffffff',
      marqueeGlow: '#fde047',
      screenBezelColor: '#78350f',
      screenGlowColor: '#fbbf24',
      deckColor: '#92400e',
      joystickBallColor: '#facc15',
      joystickBallEmissive: '#f59e0b',
      buttonColors: ['#fbbf24', '#f97316', '#38bdf8', '#ef4444'],
      coinDoorColor: '#b45309',
      sideArtAccent: '#fef3c7',
      floorGlowColor: '#f59e0b',
      topicBadgeBg: '#fef3c7',
      topicBadgeText: '#0369a1',
  ...
  // ── WING 3 (MACHINES #09 - #12) ──
  {
    id: 'chocolate-factory',
    number: '09',
    title: 'THE CHOCOLATE FACTORY',
    subtitle: 'The Great Chocolate Production Challenge',
    topic: 'Fractions',
    grade: 'Grade 6',
    category: '3D Chocolate Production',
    status: 'active',
    image: '/images/chocolate-factory-card.jpg',
    route: '/chocolate-factory',
    theme: {
      cabinetColor: '#7c3f12',
      secondaryColor: '#a9763f',
      tMoldingColor: '#f0b429',
      tMoldingEmissive: '#d97706',
      marqueeBg: '#5b2d12',
      marqueeTextColor: '#fdf6ec',
      marqueeGlow: '#f8b500',
      screenBezelColor: '#4a2410',
      screenGlowColor: '#f0b429',
      deckColor: '#84562b',
      joystickBallColor: '#f8b500',
      joystickBallEmissive: '#d97706',
      buttonColors: ['#f0b429', '#2563eb', '#dc2626', '#e8d3ae'],
      coinDoorColor: '#5b2d12',
      sideArtAccent: '#f8e3c0',
      floorGlowColor: '#d97706',
      topicBadgeBg: '#fdf0d5',
      topicBadgeText: '#7c3f12',
      cardBorderColor: '#c67c3e',
    },
  },
  {
    id: 'graphworks',
    number: '10',
    title: 'GRAPHWORKS',
    subtitle: 'The Data City • Power Your City',
    topic: 'Data Handling & Graphs',
    grade: 'Grade 6',
    category: '3D City Simulation',
    status: 'active',
    image: '/images/graphworks-card.jpg',
    route: '/graphworks',
    theme: {
      cabinetColor: '#0284c7',
      secondaryColor: '#0ea5e9',
      ...
      joystickBallColor: '#ef4444',
      joystickBallEmissive: '#dc2626',
      buttonColors: ['#38bdf8', '#ef4444', '#22c55e', '#fbbf24'],
      coinDoorColor: '#0369a1',
      sideArtAccent: '#e0f2fe',
      floorGlowColor: '#0284c7',
      topicBadgeBg: '#e0f2fe',
      topicBadgeText: '#0369a1',
      cardBorderColor: '#0284c7',
  ...
  },
  {
    ...
    number: '11',
    title: 'PERCENTAGE HARVEST',
    subtitle: 'The Smart Farm • Agricultural Percentage Duel',
    topic: 'Percentages',
    grade: 'Grade 6',
    category: '3D Smart Farm Simulation',
    status: 'active',
    image: '/images/percentage-harvest-card.jpg',
    route: '/percentage-harvest',
    theme: {
      cabinetColor: '#15803d',
      secondaryColor: '#22c55e',
      tMoldingColor: '#facc15',
      tMoldingEmissive: '#eab308',
      marqueeBg: '#14532d',
      marqueeTextColor: '#fef08a',
      marqueeGlow: '#facc15',
      screenBezelColor: '#052e16',
      screenGlowColor: '#22c55e',
      deckColor: '#166534',
      joystickBallColor: '#facc15',
      joystickBallEmissive: '#eab308',
      buttonColors: ['#22c55e', '#3b82f6', '#ef4444', '#facc15'],
      coinDoorColor: '#14532d',
      sideArtAccent: '#fef08a',
      floorGlowColor: '#22c55e',
      topicBadgeBg: '#dcfce7',
      topicBadgeText: '#14532d',
  ...
  },
  {
    ...
    theme: {
      ...
      tMoldingColor: '#94a3b8',
      tMoldingEmissive: '#64748b',
      marqueeBg: '#334155',
      marqueeTextColor: '#e2e8f0',
      marqueeGlow: '#94a3b8',
      screenBezelColor: '#1e293b',
      screenGlowColor: '#94a3b8',
      deckColor: '#334155',
      joystickBallColor: '#cbd5e1',
      joystickBallEmissive: '#94a3b8',
      buttonColors: ['#94a3b8', '#cbd5e1', '#64748b', '#e2e8f0'],
      coinDoorColor: '#334155',
      sideArtAccent: '#cbd5e1',
      floorGlowColor: '#64748b',
      topicBadgeBg: '#e2e8f0',
      topicBadgeText: '#334155',
