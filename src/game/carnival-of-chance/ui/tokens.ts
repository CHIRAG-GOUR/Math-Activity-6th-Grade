...
export const CARNIVAL_THEME = {
  ...
  activityAccents: {
    ...
    'ball-drop': {
      ...
      secondary: '#FFC928',
      accent: '#2E9B57',
      name: 'BALL DROP PLINKO',
      subtitle: 'GALTON BOARD HISTOGRAM',
      tagline: 'PEGS • NORMAL CURVE • HISTOGRAM',
      instruction: 'ANALYZE BIN PATHS → CHOOSE FRACTION → RELEASE BALL → TRACK FREQUENCY',
    },
    'probability-lab': {
      primary: '#FFF8E7',
      secondary: '#2463EB',
      ...
      subtitle: 'BALANCE SCALES & RATIOS',
      tagline: 'LEVERS • BALANCE • SCALES',
      instruction: 'CALCULATE THEORETICAL FRACTION → LOCK ANSWER → RUN TRIAL SIMULATION',
    },
    'game-builder': {
      primary: '#E53935',
      secondary: '#FFC928',
    ...
    'grand-carnival': {
      ...
      subtitle: 'TWO-TEAM CHAMPIONSHIP',
      tagline: 'CHAMPIONSHIP • PROBABILITY MASTERY',
      instruction: 'FINAL SHOWDOWN → SOLVE COMPLEX PROBABILITIES → WIN CARNIVAL TROPHY',
    },
    hub: {
      primary: '#FFC928',
      secondary: '#E53935',
