...
const MASTER_CROWD_DEFINITIONS: Array<{
  ...
  // ------------------------------------------------------------
  // ROUND 1 COHORT (Early Queue Line Arrivals outside Main North Gate)
  // ------------------------------------------------------------
  {
    id: 'crowd_q1_p1',
    name: 'Elena (Parent)',
    type: 'parent',
    spawnRound: 1,
    waitingPos: [-0.75, 0.02, -15.4], // Left Line, Pos 1
    waitingRotY: 0, // Facing South into Gate
    shirtColor: '#059669',
    pantsColor: '#334155',
    hairColor: '#b45309',
    skinColor: '#fde047',
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 1,
    waitingPos: [0.75, 0.02, -15.4], // Right Line, Pos 1
    waitingRotY: 0,
    shirtColor: '#f59e0b',
    pantsColor: '#1d4ed8',
    hairColor: '#451a03',
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 1,
    waitingPos: [-0.75, 0.02, -16.2], // Left Line, Pos 2
    waitingRotY: 0,
    shirtColor: '#ec4899',
    pantsColor: '#475569',
    hairColor: '#eab308',
    skinColor: '#fcd34d',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'qii_garden_mid', 'qii_fountain'],
  ...
  },
  {
    ...
    type: 'parent',
    spawnRound: 1,
    waitingPos: [0.75, 0.02, -16.2], // Right Line, Pos 2
    waitingRotY: 0,
    shirtColor: '#0284c7',
    pantsColor: '#1e293b',
    hairColor: '#1e293b',
    skinColor: '#fed7aa',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center'],
    targetActivity: 'Enjoying Central Plaza',
    speed: 1.1,
  },

  // ------------------------------------------------------------
  // ROUND 2 COHORT (Botanical Garden & Greenhouse Visitors)
  // ------------------------------------------------------------
  {
    id: 'crowd_q1_p3',
    ...
    type: 'elderly',
    spawnRound: 2,
    waitingPos: [-0.75, 0.02, -17.0], // Left Line, Pos 3
    waitingRotY: 0,
    shirtColor: '#475569',
    pantsColor: '#1e293b',
    hairColor: '#94a3b8',
    skinColor: '#fed7aa',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'qii_garden_mid', 'qii_gazebo'],
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 2,
    waitingPos: [0.75, 0.02, -17.0], // Right Line, Pos 3
    waitingRotY: 0,
    shirtColor: '#10b981',
    pantsColor: '#1e3a8a',
    hairColor: '#78350f',
    skinColor: '#fcd34d',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'qii_garden_mid', 'qii_garden_south'],
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 2,
    waitingPos: [-0.75, 0.02, -17.8], // Left Line, Pos 4
    waitingRotY: 0,
    shirtColor: '#8b5cf6',
    pantsColor: '#334155',
    hairColor: '#ca8a04',
  ...
  },
  {
    ...
    type: 'parent',
    spawnRound: 2,
    waitingPos: [0.75, 0.02, -17.8], // Right Line, Pos 4
    waitingRotY: 0,
    shirtColor: '#f43f5e',
    pantsColor: '#0f172a',
    hairColor: '#172554',
    skinColor: '#fcd34d',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center', 'plaza_e', 'qiv_picnic_mid', 'qiv_pond'],
    targetActivity: 'Strolling by Duck Pond',
    speed: 1.05,
  },

  // ------------------------------------------------------------
  // ROUND 3 COHORT (Sports Players & Fans)
  // ------------------------------------------------------------
  {
    id: 'crowd_q1_p5',
    ...
    type: 'child',
    spawnRound: 3,
    waitingPos: [-0.75, 0.02, -18.6], // Left Line, Pos 5
    waitingRotY: 0,
    shirtColor: '#f8fafc',
    pantsColor: '#f8fafc',
    hairColor: '#0f172a',
    skinColor: '#d97706',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center', 'plaza_w', 'qiii_sports_mid', 'qiii_pitch'],
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 3,
    waitingPos: [0.75, 0.02, -18.6], // Right Line, Pos 5
    waitingRotY: 0,
    shirtColor: '#ef4444',
    pantsColor: '#1e3a8a',
    hairColor: '#1c1917',
    skinColor: '#fcd34d',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center', 'plaza_w', 'qiii_sports_mid', 'qiii_court'],
  ...
  },
  {
    ...
    type: 'parent',
    spawnRound: 3,
    waitingPos: [-0.75, 0.02, -19.4], // Left Line, Pos 6
    waitingRotY: 0,
    shirtColor: '#0284c7',
    pantsColor: '#475569',
    hairColor: '#78350f',
    skinColor: '#fde047',
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center', 'plaza_e', 'qiv_picnic_mid', 'qiv_tables'],
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 3,
    waitingPos: [0.75, 0.02, -19.4], // Right Line, Pos 6
    waitingRotY: 0,
    shirtColor: '#f97316',
    pantsColor: '#1d4ed8',
    hairColor: '#451a03',
  ...
  },
  {
    ...
    type: 'jogger',
    spawnRound: 3,
    waitingPos: [-0.75, 0.02, -20.2], // Left Line, Pos 7
    waitingRotY: 0,
    shirtColor: '#ea580c',
    pantsColor: '#0f172a',
    hairColor: '#000000',
    skinColor: '#fcd34d',
    hasHeadband: true,
    enterPath: ['gate_north', 'axis_y_n2', 'axis_y_n1', 'plaza_n', 'plaza_center', 'plaza_s', 'qiii_sports_mid'],
    targetActivity: 'Watching Sports Matches',
    speed: 1.7,
  },

  // ------------------------------------------------------------
  // ROUND 4 COHORT (Full Queue Ready for Grand Opening)
  // ------------------------------------------------------------
  {
    id: 'crowd_q2_p7',
    name: 'Zoe (Slide Fan)',
    type: 'child',
    spawnRound: 4,
    waitingPos: [0.75, 0.02, -20.2], // Right Line, Pos 7
    waitingRotY: 0,
    shirtColor: '#a855f7',
    pantsColor: '#1e3a8a',
    hairColor: '#ca8a04',
  ...
  },
  {
    ...
    type: 'parent',
    spawnRound: 4,
    waitingPos: [-0.75, 0.02, -21.0], // Left Line, Pos 8
    waitingRotY: 0,
    shirtColor: '#0d9488',
    pantsColor: '#1e293b',
    hairColor: '#1c1917',
  ...
  },
  {
    ...
    type: 'parent',
    spawnRound: 4,
    waitingPos: [0.75, 0.02, -21.0], // Right Line, Pos 8
    waitingRotY: 0,
    shirtColor: '#db2777',
    pantsColor: '#334155',
    hairColor: '#92400e',
  ...
  },
  {
    ...
    type: 'child',
    spawnRound: 4,
    waitingPos: [-0.75, 0.02, -21.8], // Left Line, Pos 9
    waitingRotY: 0,
    shirtColor: '#38bdf8',
    pantsColor: '#0f172a',
    hairColor: '#b45309',
  ...
  },
  {
    ...
    type: 'elderly',
    spawnRound: 4,
    waitingPos: [0.75, 0.02, -21.8], // Right Line, Pos 9
    waitingRotY: 0,
    shirtColor: '#16a34a',
    pantsColor: '#334155',
    hairColor: '#e2e8f0',
