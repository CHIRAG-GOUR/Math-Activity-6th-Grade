...
const BLUE_NODES: Record<StationId, NodeDef> = {
  ...
  MIX_W: { pos: v(-14.35, 0, -5), face: v(-15.6, 0, -5) },
  IN_C: { pos: v(-14.4, 0, 2) },
  MOLD_W: { pos: v(-16.15, 0, 2), face: v(-19.5, 0, 2) },
  IN_D: { pos: v(-14.6, 0, 9.2) },
  COOL_W: { pos: v(-16.65, 0, 9.2), face: v(-19.5, 0, 9.2) },
  IN_E: { pos: v(-14.6, 0, 17) },
  CUT_W: { pos: v(-16.55, 0, 17), face: v(-19.5, 0, 17) },
  IN_F: { pos: v(-14.6, 0, 22) },
  QC_W: { pos: v(-15.6, 0, 22), face: v(-16.9, 0, 22) },
  IN_G: { pos: v(-14.8, 0, 25.6) },
  PACK_W: { pos: v(-16.65, 0, 25.6), face: v(-19.5, 0, 25.6) },
