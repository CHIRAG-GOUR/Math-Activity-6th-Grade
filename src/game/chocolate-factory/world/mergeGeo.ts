// ============================================================
// THE CHOCOLATE FACTORY — STATIC GEOMETRY BATCHING
//
// Everything that never moves relative to its parent (factory shells, walkways,
// rails, the skyline) is baked into one merged geometry per material. The scene
