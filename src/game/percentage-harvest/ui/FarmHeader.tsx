...
export const FarmHeader: React.FC = () => {
  ...
  return (
    <header className="relative z-30 w-full flex flex-col items-center px-3 pt-2 pointer-events-none">
      ...
      {activeQuestion && (
        <div className="mt-2 flex items-center justify-between gap-4 px-4 py-2 rounded-2xl bg-gradient-to-r from-blue-950 via-slate-900 to-blue-950 border-2 border-sky-500/50 text-white shadow-2xl max-w-2xl pointer-events-auto backdrop-blur-md">
          {/* Green Plant Icon Square */}
          <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 border border-emerald-300 flex items-center justify-center shadow-md">
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <div className="text-xs sm:text-sm font-black text-white leading-snug tracking-tight">
              {activeQuestion.prompt}
            </div>
          </div>

          {/* Mini 10x10 Yellow Field Preview Diagram */}
          <div className="flex items-center gap-2.5 pl-3 border-l border-white/20 shrink-0">
            <div className="w-8 h-8 rounded grid grid-cols-5 gap-0.5 p-0.5 bg-slate-800 border border-slate-600">
            ...
            <div className="text-xs font-black font-mono text-amber-300">
              {activeQuestion.targetPercentage}% = {activeQuestion.correctAnswer} {activeQuestion.unit}
            </div>
          </div>
        </div>
      )}
